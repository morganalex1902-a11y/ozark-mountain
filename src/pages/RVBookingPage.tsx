...
const steps: Step[] = ['dates', 'details', 'payment', 'confirmation'];

export default function RVBookingPage() {
        ...
        <div className="max-w-2xl mx-auto">
              ...
              {currentStep === 'confirmation' && (
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <p className="text-muted-foreground">Your RV stay has been successfully booked.</p>
                  </motion.div>
          ...
          <div className="flex justify-between gap-4 mt-12">
            ...
            {currentStep !== 'confirmation' ? (
              ...
              <Button
                onClick={() => window.location.href = '/rv-stays'}
                className="bg-accent hover:bg-accent/90 text-background"
              >
                Back to RV Stays
                <ArrowRight className="w-4 h-4 ml-2" />
